...
def loadData():
    ...
    samps, events = load_eyelink_dataset("sample_data/bino500.asc")
    ...
    # Import the image viewed and use its dimensions to determine grid size
    backgroundImage = Image.open('images/face.jpg')
    p = np.asarray(backgroundImage).astype('float')
