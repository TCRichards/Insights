...
Levels=2
Levels(1).ValueString="1\t\tTrialProc\tSacrmeto.bmp\t20000\t1\t"
Levels(2).ValueString="1\t\tTrialProc\tSac_blur.bmp\t20000\t2\t"
Name="TrialList"
TypeName="List"
Tag=""
Notes=""
...
VersionInternal=4
VersionBuild=1
_ItemList="Fixation;startRecording;pictureTrial;stopRecording"
_VersionPersist=1
FlowLines(0).Count=4
FlowLines(0).FlowItem(0).Name="Fixation"
FlowLines(0).FlowItem(1).Name="startRecording"
FlowLines(0).FlowItem(2).Name="pictureTrial"
